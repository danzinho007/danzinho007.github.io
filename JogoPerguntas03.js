// Este código é um jogo de perguntas em que os usuários respondem a perguntas de múltipla escolha. O jogo usa uma API para obter as perguntas e as respostas possíveis. O jogo armazena um objeto de estatísticas que acompanha quantas perguntas foram feitas, quantas respostas corretas foram dadas, a sequência de respostas corretas e o tempo médio de resposta.

// O jogo tem um array global de objetos, cada um representando uma pergunta, e um objeto de estatísticas global. Ele usa um arquivo JSON para obter perguntas e respostas possíveis. O jogo usa um evento de clique para lidar com a seleção de respostas, e há uma função para iniciar um novo jogo e uma função para criar uma matriz de respostas a partir dos dados da API. Existem também funções para exibir perguntas e atualizar estatísticas.
